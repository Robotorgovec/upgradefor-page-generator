...
import type { RecommendationCard, BridalMakeupPageData } from "./data";

type BridalMakeupGuidedSelectorProps = {
  selector: BridalMakeupPageData["selector"];
  recommendations: RecommendationCard[];
};

type SelectedMap = Record<string, string>;

export default function BridalMakeupGuidedSelector({
  selector,
  recommendations,
}: BridalMakeupGuidedSelectorProps) {
