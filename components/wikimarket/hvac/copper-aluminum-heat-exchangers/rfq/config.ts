...
export const ROUTING_PREFERENCE_OPTIONS: Array<{ value: RoutingPreference; label: string; description: string }> = [
  {
    ...
    description: "После отправки мы сами подберём подходящих поставщиков под вашу задачу.",
  },
  {
    value: "selected",
    label: "Отправить выбранным производителям",
    description: "Вы заранее фиксируете, кому именно нужно показать запрос.",
  },
  {
    value: "hold",
    label: "Пока оставить заявку без выбора",
    description: "Заявка сохранится, а список поставщиков можно будет согласовать отдельно.",
  },
];
